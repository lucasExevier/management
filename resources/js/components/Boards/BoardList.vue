      ...
      <div class="px-4  sm:px-0">
        ...
        <div class="flex justify-between items-center mb-8">
          <div>
            ...
            <p class="mt-1 text-gray-600">Organize your tasks with visual Kanban boards</p>
          </div>
          <router-link
            to="/boards/create"
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" @dragover.prevent @drop="handleDrop">
          <div
            ...
            :key="board.id"
            class="bg-white overflow-hidden shadow-sm border border-gray-200 rounded-lg cursor-move hover:shadow-md transition-shadow duration-200"
            draggable="true"
          ...
          >
            <div class="p-6">
              <div class="flex items-center justify-between mb-3">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <span class="text-xs text-gray-500">Position: {{ board.position }}</span>
                  </div>
                </div>
              ...
              <p class="text-sm text-gray-600 mb-4 leading-relaxed">{{ board.description || 'No description available' }}</p>
        ...
        <div v-if="boards.length === 0" class="text-center py-16">
          ...
          <h3 class="text-xl font-semibold text-gray-900 mb-2">No boards yet</h3>
          <p class="text-gray-600 mb-8 max-w-md mx-auto">Create your first Kanban board to organize tasks and improve workflow efficiency.</p>
          <router-link
            to="/boards/create"
