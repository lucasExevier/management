<template>
  ...
  <!-- Hero Section -->
  <section class="bg-gradient-to-br from-indigo-50 via-white to-cyan-50 py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        ...
        <p class="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          Have questions about Orbit? We'd love to hear from you.
        ...
        <div>
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div>
          ...
          <div class="space-y-8">
            <div class="flex items-start">
              ...
              <div>
                ...
                <p class="text-gray-600">hello@orbit.com</p>
                <p class="text-gray-600">support@orbit.com</p>
              </div>
            </div>
          ...
          <div class="mt-8">
            ...
            <div class="flex space-x-4">
              <a href="#" class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-indigo-100 transition-colors duration-200">
  ...
  <footer class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-xl font-bold mb-4">Orbit</h3>
          <p class="text-gray-400">Revolutionizing project management for modern teams.</p>
        </div>
        <div>
